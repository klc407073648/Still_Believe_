...
int main(int argc, char *argv[]) {
 ...
 /* p = "GET /test.html HTTP/1.1\r\n"
      "Connection: null\r\n\r\n";*/
  string post_content= "user=klc&password=klc";
  //string postData ="POST http://192.168.232.133:9950/log.html HTTP/1.1\r\n";
  //postData += "Host:192.168.232.133:9950 \r\n";
  string postData ="POST /log.html HTTP/1.1\r\n";
  //postData +="User-Agent: Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-CN; rv:1.9.2.3) Gecko/20100401 Firefox/3.6.3\r\n";
  postData +="Content-Type: application/x-www-form-urlencoded\r\n";
  postData +="Content-Length: " + to_string(post_content.length()) +"\r\n";
  postData +="Connection: Keep-Alive\r\n\r\n";
  postData += post_content;
  const char *p=postData.c_str();
  sockfd = socket(AF_INET, SOCK_STREAM, 0);
