...
void Common::writeLoginInfo(QString user, QString pwd, bool isRemeber, QString path)
{
    ...
    qDebug() << "login json data111 user  "<<user;
    qDebug() << "login json data111 pwd  "<<pwd;
...
QByteArray arr1=(QByteArray((char *)encUsr, encUsrLen)).toBase64();
QByteArray arr2=(QByteArray((char *)encPwd, encPwdLen)).toBase64();
qDebug() << "login json data111 user"<<arr1;
qDebug() << "login json data111 pwd"<<arr2;
