...
void Login::on_login_btn_clicked()
{
    ...
    qDebug() << "login json data"<<user;
    qDebug() << "login json data"<<pwd;
    qDebug() << "login json data"<<address;
    qDebug() << "login json data"<<port;
    // 数据校验
