...
![1](./zeromq_images/chapter2_1.png)
...
![2](./zeromq_images/chapter2_2.png)
...
![3](./zeromq_images/chapter2_3.png)

HTTP请求使用CR-LF（换行符）作为信息帧的间隔，而ZMQ则使用指定长度来定义帧：

![4](./zeromq_images/chapter2_4.png)
...
![5](./zeromq_images/chapter2_6.png)

随后，我们对这个结构不断地进行扩充，将装置放到特定的位置，进一步增加节点数量：

![6](./zeromq_images/chapter2_7.png)
...
![7](./zeromq_images/chapter2_8.png)
...
![8](./zeromq_images/chapter2_10.png)
...
![9](./zeromq_images/chapter2_11.png)
...
![10](./zeromq_images/chapter2_12.png)
