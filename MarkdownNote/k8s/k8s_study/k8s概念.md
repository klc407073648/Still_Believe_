...
![Kubernetes架构](./k8s_images/architecture.png)
...
![Kuberentes架构](./k8s_images/kubernetes-high-level-component-archtecture.jpg)

### 分层架构

Kubernetes 设计理念和功能其实就是一个类似 Linux 的分层架构，如下图所示

![Kubernetes 分层架构示意图](./k8s_images/006tNc79ly1fzniqvmi51j31gq0s0q5u.jpg)
...
![开放接口](./k8s_images/open-interfaces.jpg)
